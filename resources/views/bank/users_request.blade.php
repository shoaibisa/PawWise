@include('pages.header', ['title' => "User request to your banks"]) @include('pages.navbar') @include('pages.sidebar')
 <script>
    ...
    function verifyU(uid){
        ...
        xmlhttp3.open("GET", "/VerifyUser/"+uid, true);
        xmlhttp3.send();
    }
 </script>
<main id="main" class="main">
    <div class="container">
        ...
        <div class="mt-10 pagetitle ">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="mt-5 mb-2">All User request to your bank Lists</h1>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="verifiying" class="form-select" id="{{$u->id}}" onchange="verifyU(this.value)">
                                                        <option value="{{$u->pivot->id}}"  {{$u->pivot->verified==0?'selected':''}}> 
                                                              Not Verified </option>
                                                        <option value="{{$u->pivot->id}}" {{$u->pivot->verified?'selected':''}}> <p class="text-success">Verified</p>
                                                        </option>
